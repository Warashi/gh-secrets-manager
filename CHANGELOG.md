...
## [v0.0.6](https://github.com/Warashi/gh-secrets-manager/compare/v0.0.5...v0.0.6) - 2025-06-29
- chore(deps): Bump nixbuild/nix-quick-install-action from 30 to 31 by @dependabot in https://github.com/Warashi/gh-secrets-manager/pull/26
- chore(deps): Bump nixbuild/nix-quick-install-action from 31 to 32 by @dependabot in https://github.com/Warashi/gh-secrets-manager/pull/28
- chore(deps): Bump cli/gh-extension-precompile from 2.0.0 to 2.1.0 by @dependabot in https://github.com/Warashi/gh-secrets-manager/pull/29
- chore(deps): Bump github/codeql-action from 3.29.0 to 3.29.1 by @dependabot in https://github.com/Warashi/gh-secrets-manager/pull/30
